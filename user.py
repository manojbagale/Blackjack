...
#--------------- ex. Drew a 10 Drew a 2 until now ------------------------
...
while total_hand_after_two < 21 and total_hand_after_two >= 4:
    
    ask_the_user = input(f"You have {total_hand_after_two}. Hit (y/n)? ")
  ...
  # their rank.
        ...
        # if total_hand_after_two < 21:
        #     print(f"You have {total_hand_after_two}.")
