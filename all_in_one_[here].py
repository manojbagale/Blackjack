...
while dealer_hand_value < 17:
  ...
  if num_cards > 1 and dealer_hand_value < 17:
...
if (dealer_hand_value >= 4 and dealer_hand_value < 21) and (hand_value < 21 and hand_value >=4):
...
elif dealer_hand_value >= 21 and hand_value >= 21:

  if dealer_hand_value == 21 and hand_value != 21:
    print("Dealer wins!")
